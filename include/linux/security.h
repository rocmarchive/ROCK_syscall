...
int security_file_ioctl(struct task_struct *tsk, struct file *file,
...
static inline int security_inode_permission(struct task_struct *tsk,
...
static inline int security_file_permission(struct task_struct *tsk,
...
static inline int security_file_ioctl(struct task_struct *tsk, struct file *file,
                                      unsigned int cmd, unsigned long arg)
{
	return 0;
}
...
int security_socket_sendmsg(struct task_struct *tsk, struct socket *sock,
...
static inline int security_socket_sendmsg(struct task_struct *tsk,
					  struct socket *sock,
					  struct msghdr *msg, int size)
{
	return 0;
